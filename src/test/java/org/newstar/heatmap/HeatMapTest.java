...
public class HeatMapTest {
	...
	private static final HeatMap heatMap = new HeatMap();
	...
	private static void writeToFile(BufferedImage bufferedImage, final String outputFileName) {
        String extension = "";
    ...
    public static void main(String[] args) {
		...
		try {
			reader = new BufferedReader(new InputStreamReader(getInputStream("data/test.json")));
